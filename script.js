...
function checkDataThreePlayers() {
  ...
  for (let i = 0; i < 3; i++) {
    ...
    for (let j = 0; j < 5; j++) {
      if (setPointsThreePlayers[10 * i + j].value == '') {
        setPointsThreePlayers[10 * i + j].value = 0;
      }
      if (setPointsThreePlayers[10 * i + j + 5].value == '') {
        setPointsThreePlayers[10 * i + j + 5].value = 0;
      }
      const score1 = parseInt(setPointsThreePlayers[10 * i + j].value);
      ...
      if (
        ...
        if (maxScore > 0) {
          ...
          setPointsThreePlayers[10 * i + j + 5].value = '';
          setPointsThreePlayers[10 * i + j].placeholder = '';
          setPointsThreePlayers[10 * i + j + 5].placeholder = '';
        }
      }
    }
  }
...
function checkDataFourPlayers() {
  ...
  for (let i = 0; i < 6; i++) {
    let matchFinished = false;
    for (let j = 0; j < 5; j++) {
      if (setPoints[10 * i + j].value == '') {
        setPoints[10 * i + j].value = 0;
      }
      if (setPoints[10 * i + j + 5].value == '') {
        setPoints[10 * i + j + 5].value = 0;
      }
      const score1 = parseInt(setPoints[10 * i + j].value);
      ...
      if (
        ...
        if (minScore > 0) {
          ...
          setPoints[10 * i + j].value = '';
          setPoints[10 * i + j + 5].value = '';
          setPoints[10 * i + j].placeholder = '';
          setPoints[10 * i + j + 5].placeholder = '';
        }
      }
    }
  }
